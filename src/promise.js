...
module.exports = function () {
    ...
    Promise.prototype._then = function (
        ...
        if (!BIT_FIELD_CHECK(IS_PENDING_AND_WAITING_NEG)) {
            ...
            target._addCallbacks(didFulfill,
                didReject,
                promise,
                receiver,
                domain);
    ...
    Promise.prototype._settlePromise =
        function (promise, handler, receiver, value) {
            ASSERT(!this._isFollowing());
            ...
            if (BIT_FIELD_CHECK(IS_CANCELLED)) {
                ...
                if (!isPromise) {
                    ...
                    this._settlePromiseFromHandler(handler,
                        receiver, value, promise);
                }
            } else if (receiver instanceof Proxyable) {
        ...
        if (len > 0) {
            if (BIT_FIELD_CHECK(IS_REJECTED_OR_CANCELLED)) {
                ...
                this._settlePromise0(
                    this._fulfillmentHandler0, value, bitField);
